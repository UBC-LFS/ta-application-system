# Generated by Django 2.2 on 2019-11-12 17:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_number', models.CharField(blank=True, max_length=7, null=True, unique=True)),
                ...
                ('union_correspondence', models.FileField(blank=True, null=True, upload_to=users.models.create_union_correspondence_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf'])])),
                ('compression_agreement', models.FileField(blank=True, null=True, upload_to=users.models.create_compression_agreement_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('uploaded', models.FileField(blank=True, null=True, upload_to=users.models.create_resume_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'pdf', 'doc', 'docx'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_details', models.TextField(blank=True, null=True)),
