...
urlpatterns = [
    ...
    path('confidential_information/<str:username>/sin/<str:filename>/download/', views.download_sin, name='download_sin'),
    path('confidential_information/<str:username>/study_permit/<str:filename>/download/', views.download_study_permit, name='download_study_permit'),
