...
urlpatterns = [
    ...
    path('sessions/<str:session_slug>/edit/path/<str:path>/', views.edit_session, name='edit_session'),
    path('sessions/<str:session_slug>/path/<str:path>/', views.show_session, name='show_session'),
